...
fun initRuntimeSocketService(): UTSPromise<Boolean> {
    ...
    val id: String = "app-android_UWkg9q"
    if (hosts == "" || port == "" || id == "") {
...
val GenPagesHomeHomeClass = CreateVueComponent(GenPagesHomeHome::class.java, fun(): VueComponentOptions {
    return VueComponentOptions(type = "page", name = "", inheritAttrs = GenPagesHomeHome.inheritAttrs, inject = GenPagesHomeHome.inject, props = GenPagesHomeHome.props, propsNeedCastKeys = GenPagesHomeHome.propsNeedCastKeys, emits = GenPagesHomeHome.emits, components = GenPagesHomeHome.components, styles = GenPagesHomeHome.styles, setup = fun(props: ComponentPublicInstance): Any? {
        return GenPagesHomeHome.setup(props as GenPagesHomeHome)
    }
    )
}
, fun(instance, renderer): GenPagesHomeHome {
    return GenPagesHomeHome(instance, renderer)
}
)
open class SwitchChangeDetail (
    @JsonNotNull
    open var value: Boolean = false,
) : UTSObject(), IUTSSourceMap {
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("SwitchChangeDetail", "pages/me/me.uvue", 29, 6)
    }
}
open class SwitchChangeEvent (
    @JsonNotNull
    open var detail: SwitchChangeDetail,
) : UTSObject(), IUTSSourceMap {
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("SwitchChangeEvent", "pages/me/me.uvue", 33, 6)
    }
}
...
, fun(instance, renderer): GenPagesGameGame {
    return GenPagesGameGame(instance, renderer)
}
)
...
open class UniAppConfig : io.dcloud.uniapp.appframe.AppConfig {
    override var name: String = "uni-Chess"
    override var appid: String = "__UNI__C4B6EBD"
...
fun definePageRoutes() {
    __uniRoutes.push(UniPageRoute(path = "pages/home/home", component = GenPagesHomeHomeClass, meta = UniPageMeta(isQuit = true), style = _uM("navigationBarTitleText" to "Chess", "navigationStyle" to "default")))
    __uniRoutes.push(UniPageRoute(path = "pages/me/me", component = GenPagesMeMeClass, meta = UniPageMeta(isQuit = false), style = _uM("navigationBarTitleText" to "Me", "navigationStyle" to "default")))
    __uniRoutes.push(UniPageRoute(path = "pages/game/game", component = GenPagesGameGameClass, meta = UniPageMeta(isQuit = false), style = _uM("navigationBarTitleText" to "")))
}
val __uniTabBar: Map<String, Any?>? = _uM("color" to "#8A8A8A", "selectedColor" to "#1F6FEB", "backgroundColor" to "#FFFFFF", "borderStyle" to "black", "list" to _uA(
    _uM("pagePath" to "pages/home/home", "text" to "Home", "iconPath" to "static/tab/tab-home.png", "selectedIconPath" to "static/tab/tab-home-active.png"),
    _uM("pagePath" to "pages/me/me", "text" to "Me", "iconPath" to "static/tab/tab-me.png", "selectedIconPath" to "static/tab/tab-me-active.png")
))
val __uniLaunchPage: Map<String, Any?> = _uM("url" to "pages/home/home", "style" to _uM("navigationBarTitleText" to "Chess", "navigationStyle" to "default"))
fun defineAppConfig() {
    __uniConfig.entryPagePath = "/pages/home/home"
    __uniConfig.globalStyle = _uM()
    __uniConfig.getTabBarConfig = fun(): Map<String, Any>? {
        return _uM("color" to "#8A8A8A", "selectedColor" to "#1F6FEB", "backgroundColor" to "#FFFFFF", "borderStyle" to "black", "list" to _uA(
            _uM("pagePath" to "pages/home/home", "text" to "Home", "iconPath" to "static/tab/tab-home.png", "selectedIconPath" to "static/tab/tab-home-active.png"),
            _uM("pagePath" to "pages/me/me", "text" to "Me", "iconPath" to "static/tab/tab-me.png", "selectedIconPath" to "static/tab/tab-me-active.png")
        ))
    }
